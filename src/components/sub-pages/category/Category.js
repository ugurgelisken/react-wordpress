...
function Category( { t } ) {
    ...
    const [categoryItem, setCategorItem] = useState(0);
    ...
    useEffect(() => {
        ...
        const fetch = async () => {
            ...
            for (var item of result_categories.data) {
            ...
            let result = await axios("posts?per_page=" + perPage5 + "&page=" + currentPage + "&categories=" + id)
